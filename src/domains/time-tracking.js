...
// Temporary backwards imports: loadAllData/openEditTaskModal aren't extracted yet
// (loadAllData -> data loader, openEditTaskModal -> task-modal domain).
import { loadAllData, openEditTaskModal } from '../main.js';
