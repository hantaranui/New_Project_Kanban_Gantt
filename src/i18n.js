...
export const i18n = {
  fr: {
    ...
    manageGroupsTitle: 'Gérer les groupes',
    manageGroupsSubtitle: 'Ajoutez ou supprimez des groupes utilisés dans votre équipe',
    addGroupOption: 'Ajouter un groupe',
    newGroupPlaceholder: 'Nom du nouveau groupe',
    groupsUpdated: 'Groupes mis à jour !',
    confirmDeleteGroupOption: 'Supprimer ce groupe ?',
    cannotDeleteUsedGroupOption: 'Ce groupe est utilisé par des utilisateurs',
    addUser: 'Ajouter',
